...
export let getTown = (lat, long) => { //TODO: ADD OTHER LANGUAGES SUPPORT!
    return axios.get(`https://geocode-maps.yandex.ru/1.x?apikey=a2b8af4a-0675-4706-aafc-c386bc1661ee&lang=ru_RU&format=json&geocode=${long},${lat}`)
}
